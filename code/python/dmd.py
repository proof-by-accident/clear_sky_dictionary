...
############################
# Functions to perform the multiresolution DMD
############################
...
# performs the multiresolution DMD as defined in XX
# _Arguments_
# Xraw: matrix of observations
# dt: time delta between cols of Xraw
# r: rank of DMD
# max_cyc: number of ???
# L: level of DMD
...
# performs the sparse multiresolution DMD as defined in XX. Code copied from MATLAB code written by Dr. Marcos Netto
# _Arguments_
# Xraw: matrix of observations
# dt: time delta between cols of Xraw
# r: rank of DMD
